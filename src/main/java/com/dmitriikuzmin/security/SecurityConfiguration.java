...
public class SecurityConfiguration extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http.authorizeRequests()
                ...
                .antMatchers(HttpMethod.GET, "/trainer/**").hasAnyRole("ADMIN", "TRAINER")
                ...
                .antMatchers(HttpMethod.POST, "/trainer_schedule/**").hasAnyRole("ADMIN", "TRAINER")
                .antMatchers(HttpMethod.GET, "/trainer_schedule/**").hasAnyRole("ADMIN", "TRAINER", "APPRENTICE")
                .antMatchers(HttpMethod.DELETE, "/trainer_schedule/**").hasAnyRole("ADMIN", "TRAINER")
                .antMatchers(HttpMethod.POST, "/training/**").hasAnyRole("ADMIN", "TRAINER", "APPRENTICE")
                .antMatchers(HttpMethod.GET, "/training/trainer").hasAnyRole("ADMIN", "TRAINER")
                .antMatchers(HttpMethod.GET, "/training/apprentice").hasAnyRole("ADMIN", "TRAINER", "APPRENTICE")
                .antMatchers(HttpMethod.GET, "/training/**").hasAnyRole("ADMIN", "TRAINER", "APPRENTICE")
